    ...
    <div className="flex flex-col min-h-screen bg-[#0a0e1a] text-white">
      ...
      <main className="flex-1 overflow-auto flex">
        ...
        <div className="w-96 border-r border-white/[0.06] bg-[#0d1220] overflow-y-auto">
          <div className="sticky top-0 px-6 py-4 border-b border-white/[0.06] bg-[#0d1220]/95 backdrop-blur">
            <h2 className="text-lg font-semibold text-white">Git Timeline</h2>
            <p className="text-sm text-white/60 mt-1">main branch</p>
          </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-mono text-purple-400">{commit.hash}</p>
          ...
          {selectedCommit && (
            <div className="p-8">
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 mt-2">Commit <span className="font-mono text-purple-400">{selectedCommit.hash}</span></p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-4 gap-4 mb-8">
                ...
                >
                  <div>
                    <p className="text-sm text-white/60 mb-1 font-semibold">Services</p>
                    <p className="text-2xl font-bold text-blue-400">{selectedCommit.services}</p>
                  </div>
                ...
                <motion.div
                  ...
                  className="p-4 rounded-xl bg-gradient-to-br from-amber-500/10 to-amber-500/5 border border-amber-500/20 flex items-start justify-between"
                >
                  <div>
                    <p className="text-sm text-white/60 mb-1 font-semibold">Databases</p>
                    <p className="text-2xl font-bold text-amber-400">{selectedCommit.databases}</p>
                  </div>
                ...
                >
                  <div>
                    <p className="text-sm text-white/60 mb-1 font-semibold">Diff</p>
                    <p className="text-lg font-bold text-purple-400 mt-1">{selectedCommit.changes}</p>
                  </div>
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-lg font-semibold text-white">System Architecture After Commit</h2>
                  <div className="px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 text-xs font-semibold">
                    Live View
                  </div>
                </div>
                ...
                <div className="relative bg-[#0a0e1a] rounded-xl p-8 border border-white/[0.06] overflow-hidden" style={{ minHeight: '340px' }}>
                  ...
                  <div className="relative flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 h-full z-10 w-full pt-4">
                    ...
                    {/* Connecting Lines */}
                    <div className="hidden md:flex flex-col gap-12 text-white/20">
                    ...
                    <div className="flex flex-col gap-10">
                      ...
                      >
                        ...
                        <p className="font-semibold text-white/90">UserService</p>
                        <span className="px-2 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-xs text-blue-400 font-mono mt-1">Spring Boot</span>
                      </motion.div>
                      ...
                      >
                        ...
                        <p className="font-semibold text-white/90">OrderService</p>
                        <span className="px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-xs text-emerald-400 font-mono mt-1">Go + gRPC</span>
                      </motion.div>
                    </div>

                    {/* Connecting Lines */}
                    <div className="hidden md:flex flex-col gap-10">
                       <div className="flex items-center text-white/20 h-24">
                    ...
                    <div className="flex flex-col gap-10">
                      ...
                      >
                        ...
                        <p className="font-semibold text-white/90 text-sm">UserDB</p>
                        <span className="px-2 py-0.5 rounded-full bg-amber-500/10 border border-amber-500/20 text-[10px] text-amber-400 font-mono mt-1">PostgreSQL</span>
                      </motion.div>
                      ...
                      <motion.div 
                        ...
                        className="flex flex-col items-center"
                      >
                        <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-rose-500 to-rose-600 border border-rose-400/30 flex items-center justify-center mb-3 shadow-lg shadow-rose-500/20">
                          <Database className="w-8 h-8 text-white" />
                        </div>
                        <p className="font-semibold text-white/90 text-sm">OrderDB</p>
                        <span className="px-2 py-0.5 rounded-full bg-rose-500/10 border border-rose-500/20 text-[10px] text-rose-400 font-mono mt-1">MongoDB</span>
                      </motion.div>
                    </div>
              ...
              <motion.div
                ...
                className="p-6 rounded-xl bg-[#0d1220] border border-white/[0.06] text-white/90 font-mono text-sm"
              >
